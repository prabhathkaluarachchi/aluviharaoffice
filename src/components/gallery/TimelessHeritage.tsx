  ...
  return (
    <div className="px-4 sm:px-6 md:px-16 py-10 md:py-20 bg-transparent">
      ...
      <div className="hidden lg:block">
        <div className="bg-[#F7F6F6] relative overflow-visible pt-5 pb-2 lg:pb-10 rounded-lg">
          ...
          <div className="max-w-[80%] mx-auto grid lg:grid-cols-2 gap-8 items-start">
            {/* Left: Text */}
            <div className="pr-8">
            ...
            <div className="relative h-[450px]">
              ...
              <img
                ...
                alt="Heritage 2"
                className="absolute top-30 right-0 w-full max-w-[350px] z-10 rounded-sm"
              />
            </div>
          </div>
        </div>
...
//   return (
//     <div className="px-4 sm:px-6 md:px-16 py-10 md:py-20 bg-transparent">
//       <div className="bg-[#F7F6F6] relative overflow-visible pt-5 pb-2 md:pb-2 lg:pb-10 rounded-lg">
...
//             <div className="relative hidden md:block h-[300px] md:h-[400px] lg:h-[450px]">
